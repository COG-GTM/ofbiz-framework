...
<div id="loginBar"><span>${uiLabelMap.CommonBeLogged}</span><div id="tyson-wordmark"><span class="tyson-wordmark-main">TYSON</span><span class="tyson-wordmark-sep">|</span><span class="tyson-wordmark-sub">Trade</span></div></div>
<center>
