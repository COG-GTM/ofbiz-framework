...
<head>
    ...
    <title>Tyson Trade: <#if (titleProperty)?has_content>${uiLabelMap[titleProperty]}<#else>${title!}</#if></title>
...
<link rel="stylesheet/less" href="<@ofbizContentUrl>/tyson/${visualTheme.visualThemeId}.less</@ofbizContentUrl>" type="text/css"/>
