...
<#if userLogin?has_content>
    <#assign appMax = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyAsInteger("tyson", "appMax", 8)/>
...
<div id="main-navigation-bar">
    <div id="main-nav-bar-left">
        ...
        <div id="main-nav-bar-right">
            <div id="tyson-wordmark"><span class="tyson-wordmark-main">TYSON</span><span class="tyson-wordmark-sep">|</span><span class="tyson-wordmark-sub">Trade</span></div>
